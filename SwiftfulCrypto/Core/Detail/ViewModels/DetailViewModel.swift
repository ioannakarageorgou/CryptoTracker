...
private extension DetailViewModel {
    func mapDataToStatistics(coinDetailModel: CoinDetailModel?, coinModel: CoinModel)-> (overview: [StatisticModel], additional: [StatisticModel]) {
    ...
    func createAdditionalArray(coinDetailModel: CoinDetailModel?, coinModel: CoinModel) -> [StatisticModel] {
        ...
        let blocTimeStat = StatisticModel(title: "BlockTime", value: blockTimeString)
